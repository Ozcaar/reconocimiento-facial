...
color_black_btn = "#020D19"
color_background = "#101720"
...
####Configuración insertado del usuario####
    ...
    if(res_db["affected"]):
        ...
        if img_user in my_files:
            ...
            if comp >= 0.90:
                ...
                printAndShow(screen2, "¡Error! Incompatibilidad de datos", 0)
            os.remove(img_user)
...
root.title("Reconocimiento facial de empleados")
